python q2l_train.py --dataname 'heart' -a 'Q2L-SwinL-384' --img_size 448 -b 16 --epochs 5 --lr 0.00000005 --num_labels 26 --resume checkpoint/Q2L-SwinL-384/heart/26/model_best.pth.tar
