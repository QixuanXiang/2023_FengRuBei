...
from lib.MyMethod.output2 import classify
import io
...
def main_worker(args, get_image):
    ...
    weights_path = "checkpoint/Q2L-SwinL-384/heart/3/model_best.pth.tar"
    ...
    return classify(output.argmax(1))
