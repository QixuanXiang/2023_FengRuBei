...
def get_datasets(args):
    ...
    if args.dataname == 'coco' or args.dataname == 'coco14':
        ...
        val_dataset = CoCoDataset(
            image_dir='/root/2022_bishe/q2l/data/heartTU_images',
            anno_path='/root/2022_bishe/q2l/data/heartTU_annotation.json',
        ...
        # modify
        coco_root = '/root/2022_bishe/q2l/data/'
        img_root = '/root/2022_bishe/q2l/data/heartTU_images'
